    ...
    <PageContainer>
      <article className="mx-auto max-w-3xl">
        ...
        <nav className="mb-4 text-xs text-text-muted">
          <Link href={`/${locale}/blog`} className="hover:text-crystal-blue">
            {t('title')}
          </Link>
        ...
        <header className="mb-8">
          <div className="mb-3 flex items-center gap-3">
            <span className="rounded-full bg-crystal-blue/10 px-2.5 py-0.5 text-xs font-medium text-crystal-blue">
          ...
          <h1 className="mb-3 font-display text-3xl font-bold leading-tight">
            {title}
          </h1>
        ...
        {article.manhwa_links.length > 0 && (
          <div className="mt-10 rounded-lg border border-border bg-surface p-6">
            <h2 className="mb-4 font-display text-lg font-semibold">{t('relatedManhwa')}</h2>
